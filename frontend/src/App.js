...
import Nav from './page/Nav';         //  THÊM NAV VÀO ĐÂY
import Footer from './page/Footer';   //  THÊM FOOTER (nếu muốn cố định cho tất cả trang)
  ...
  return (
    <div className="App" style={bgStyle}>
      <Router>
        ...
        <main style={{ paddingTop: '90px' }}> {/* để tránh bị đè bởi Nav fixed-top */}
          <Routes>
